...
from modules.mixers.nmix_graph import GraphQMixer
from modules.mixers.nmix_transf import TransQMixer
...
class NQLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        elif args.mixer == "qmix_graph":
            self.mixer = GraphQMixer(args)
        elif args.mixer == "qmix_transformer":
            self.mixer = TransQMixer(args)
        else:
            raise "mixer error"
